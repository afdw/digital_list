...
For the following, we will denote by \coqinline{A} some data type. A ``complete binary leaf tree'' of depth $d$ has $2^d$ leaves where it stores values of type \coqinline{A}.
